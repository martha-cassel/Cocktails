...
class MixesControllerTest < ActionController::TestCase
  ...
  test "should create mix" do
    assert_difference('Mix.count') do
      post :create, mix: { drink_id: @mix.drink_id, mixable_id: @mix.mixable_id, mixable_type: @mix.mixable_type }
    end
  ...
  test "should update mix" do
    put :update, id: @mix, mix: { drink_id: @mix.drink_id, mixable_id: @mix.mixable_id, mixable_type: @mix.mixable_type }
    assert_redirected_to mix_path(assigns(:mix))
  end
